...
export const envValidationSchema = Joi.object({
  ...
  REPORTS_DAILY_LIMIT: Joi.number().integer().min(1).default(200),
  REPORTS_COLLUSION_THRESHOLD: Joi.number().integer().min(1).default(30),
  REPORTS_COLLUSION_WINDOW_HOURS: Joi.number().integer().min(1).default(1),
  REPORTS_PER_IP_PER_MINUTE: Joi.number().integer().min(1).default(50),
